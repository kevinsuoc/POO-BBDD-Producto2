...
public class SocioInfantilTest {
    ...
    void agregarSocio() {
        ...
        SocioInfantil socioInfantil1 = new SocioInfantil(888, "Alex", (SocioAdulto) new Socio("Juan", 1235));
        ...
        void mostrarSocioInfantil(){
            SocioInfantil socioInfantil1 = new SocioInfantil(888, "Alex", (SocioAdulto) new Socio("Juan", 1235));
            SocioInfantil socioInfantil2 = new SocioInfantil(999, "Ana", (SocioAdulto) new Socio("Marc", 5568));
    ...
    // Si quitamos de la clase adulto que sea abstracta me deja hacer el test con esta opcion por eso lo deje comentado
    /*
    public class SocioInfantilTest {
    private List<SocioInfantil> listaSocioInfantil = new ArrayList<>();
    ...
    void agregarSocio() {
        ...
        SocioAdulto tutor = new SocioAdulto("Juan", 1235);
        SocioInfantil socioInfantil1 = new SocioInfantil(888, "Alex", tutor);
    ...
    void mostrarSocioInfantil() {
        ...
        SocioAdulto tutor1 = new SocioAdulto("Juan", 1235);
        SocioAdulto tutor2 = new SocioAdulto("Marc", 5568);
